...
import GenreTree from './genreTree.js';
...
If you hover over the visualization you can see the exact number of songs produced by each of the
three categories.
`;
...
By clicking the buttons you can switch between decades. And, by hovering over the visualization you can
see exact numbers of songs.
`;
...
spoken words in a track. String Lovers score high on Instrumentalness but low on Speechiness. Therefore in this cluster, artists tend to
favor instruments over pure vocals. Poetics, on the other hand, are the opposite. You
...
Evidently, over the last number of decades, Americans have gravitated towards becoming
Poetics who predominantly listen to music with a higher volume of lyrics from previously being String Lovers.
Once again considering time as a variable, we see that most String Lovers appeared on Billboard before the 1990s while the majority of Poetics
    ...
    return (
      <div className="relative">
        ...
        <table className="table margin">
          ...
          <h1 style={{ color: '#EA0484', display: 'inline', fontSize: 40}}> Rock</h1>
          <h1 style={{ color: '#404040', display: 'inline', fontSize: 40}}> </h1>
        <table>
          <tr>
